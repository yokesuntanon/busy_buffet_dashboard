...
def main():
    ...
    with st.sidebar:
        ...
        page = st.radio(
            ...
            [
                "Overview",
                "Statement 1: Long Waiting Times",
                "Statement 2: Capacity Overload",
                "Statement 3: Low Table Turnover",
    ...
    # STATEMENT 1
    ...
    elif page == "Statement 1: Long Waiting Times":
        verdict_badge("PARTIALLY TRUE", "#F9A822", "#FAECB6")
        ...
        with col1:
            ...
            bar_colors = [C_BLUE, C_RED, C_LIGHT_BLUE, C_ORANGE]
    ...
    # STATEMENT 2
    ...
    elif page == "Statement 2: Capacity Overload":
        ...
        insight_box(
            ...
            "<b>Explanation:</b> 3 out of 5 days had <b>zero queuing. "
            "The congestion happened only in Sat and Sun"
    ...
    elif page == "Action 2 — Raise Price Daily":
        verdict_badge("WON'T WORK", "#FFFFFF", C_RED)
        st.title("Action 2")
        st.markdown(
    ...
    # ACTION 3
        ...
        insight_box(
            "<b>Why it won't work:</b> On the busiest day (Sun), 49 groups were queuing. "
