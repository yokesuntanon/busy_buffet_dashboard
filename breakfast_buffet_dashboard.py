...
def main():
    ...
    if page == "Overview":
        ...
        with col2:
            ...
            fig_dur.add_trace(go.Bar(
                ...
                marker_color=C_BLUE,
                text=[f"{v:.0f} " for v in ih_dur], textposition="outside",
            ))
            fig_dur.add_trace(go.Bar(
                name="Walk in", x=DAY_ORDER,
                y=[round(v, 1) for v in wi_dur],
                marker_color=C_ORANGE,
                text=[f"{v:.0f} " for v in wi_dur], textposition="outside",
            ))
    ...
    elif page == "Statement 1":
        verdict_badge("PARTIALLY TRUE", "#000000", "#F9A822")
    ...
    # STATEMENT 2
        ...
        insight_box(
            ...
            "<b>Explanation:</b> 3 out of 5 days had zero queuing. "
    ...
    elif page == "Statement 3":
        verdict_badge("TRUE", "#000000", C_GREEN)
    ...
    # ACTION 1
        ...
        st.title("Action 1: Reduce seating time")
        st.markdown(
        ...
        insight_box(
            "<b>Explanation why it won't work:</b> Nobody is using the 5-hour allowance. "
    ...
    # ACTION 3
        ...
        metric_row([
            ("Sun total queued", "49", "groups waiting on busiest day"),
    ...
    # TASK 3 — Recommended SOLUTION
        ...
        st.title("Dynamic pricing: target the busy days")
        explain_box(
